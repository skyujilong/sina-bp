...
function answerLineOk(questions, answerList) {
    return __awaiter(this, void 0, void 0, function () {
        var answer, _i, answerList_1, item;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!true) return [3 /*break*/, 2];
                    return [4 /*yield*/, answerLine(questions)];
                case 1:
                    answer = _a.sent();
                    for (_i = 0, answerList_1 = answerList; _i < answerList_1.length; _i++) {
                        item = answerList_1[_i];
                        if (item.toLocaleLowerCase() === answer.toLocaleLowerCase()) {
                            return [2 /*return*/, answer.toLocaleLowerCase()];
                            break;
                        }
                    }
                    return [3 /*break*/, 0];
